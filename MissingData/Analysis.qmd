...
```{r}
#| echo: fenced
missing_plot(ex_data, dependent = "y", explanatory = c("x_complete", "x_mcar", "x_mar", "x_mnar"), plot_opts = theme(plot.background = element_rect(colour="#E5E4CE",fill="#E5E4CE",size=1)))
```
