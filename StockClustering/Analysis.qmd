...
![Source: <https://www.pexels.com/tr-tr/fotograf/belgenin-ustundeki-buyutec-6801648/>](images/paste-0B2C4B8E.png){width="400"}
...
fviz_nbclust(data_scaled, kmeans, method = "silhouette", k.max = 10) + theme(plot.background = element_rect(colour="#E5E4CE",fill="#E5E4CE",size=1))
```
...
fviz_cluster(object = model,
             ...
             palette = "jco",
             main = "",
             ggtheme = theme_minimal()) + theme(plot.background = element_rect(colour="#E5E4CE",fill="#E5E4CE",size=1))
```
...
fviz_silhouette(sil, palette = "jco", ggtheme = theme_classic()) + theme(plot.background = element_rect(colour="#E5E4CE",fill="#E5E4CE",size=1))
```
